...
D?a tr?n d? li?u th?i ti?t OpenWeather + sensor reading + history, h?y d? b?o quanh v? tr? citizen trong b?n k?nh {radiusKm:0.##}km.

T?a ?? citizen: ({latitude}, {longitude})

D? li?u ??u v?o (JSON):
{inputsJson}

Tr? v? DUY NH?T m?t JSON h?p l?, kh?ng markdown, v?i c?c kh?a:
- ""riskLevel"": m?t trong ""Low"", ""Medium"", ""High"".
- ""summary"": 2-4 c?u ti?ng Vi?t, n?u r? quanh v? tr? citizen c? nguy c? ng?p hay kh?ng.
- ""recommendations"": m?ng 2-5 g?i ? h?nh ??ng th?c t?.
- ""confidenceNote"": m?t c?u v? ?? tin c?y/limitation.
